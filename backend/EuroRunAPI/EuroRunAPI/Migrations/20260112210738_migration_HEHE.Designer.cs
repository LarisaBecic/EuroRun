...
namespace EuroRunAPI.Migrations
{
    ...
    [Migration("20260112210738_migration_HEHE")]
    partial class migration_HEHE
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EuroRunAPI.Authentification.Models.AuthentificationToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EuroRunAPI.Modul.CreditCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EuroRunAPI.Modul.Models.Award", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EuroRunAPI.Modul.Models.EventRegistration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EuroRunAPI.Modul.Models.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("EventRegistration_id")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CreditCard_id");

                    b.HasIndex("EventRegistration_id");
            ...
            modelBuilder.Entity("EuroRunAPI.Modul.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EuroRunAPI.Authentification.Models.AuthentificationToken", b =>
                {
                    b.HasOne("EuroRunAPI.Modul.Models.UserAccount", "UserAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("EuroRunAPI.Modul.Models.Payment", b =>
                {
                    b.HasOne("EuroRunAPI.Modul.CreditCard", "CreditCard")
                        .WithMany()
                        .HasForeignKey("CreditCard_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EuroRunAPI.Modul.Models.EventRegistration", "EventRegistration")
                        .WithMany()
                        .HasForeignKey("EventRegistration_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
